# Tunisia (TUN) — チーム分析レポート

> **グループ F** ｜ 主戦フォーメーション: `4-2-3-1` ｜ 平均OVR: **71.0** ｜ 分析試合数: 6試合 (StatsBomb)
...
### Ellyes Skhiri (OVR 80)
- **ポジション**: MF  |  **クラブ**: Eintracht Frankfurt
- **年齢**: 31  |  **代表キャップ**: 81  |  **代表得点**: 4
- **能力値**: PAC 64 / SHO 73 / PAS 74 / DRI 75 / DEF 80 / PHY 74
...
|------|----------|:------:|:---------------:|
| FIFA World Cup 2022 | France | 1-0 | 3-4-2-1 |
| FIFA World Cup 2022 | Denmark | 0-0 | 3-4-3 |
| FIFA World Cup 2022 | Australia | 0-1 | 3-4-2-1 |
| AFCON 2023 | Mali | 1-1 | 4-4-2 |
| AFCON 2023 | Namibia | 0-1 | 4-3-3 |
...
グループ **F** の対戦相手: Netherlands, Japan, Sweden
