# Bosnia & Herzegovina (BIH) — チーム分析レポート

> **グループ B** ｜ 主戦フォーメーション: `不明` ｜ 平均OVR: **71.0** ｜ 分析試合数: 0試合 (StatsBomb)
...
### Edin Džeko (OVR 81)
- **ポジション**: FW  |  **クラブ**: Schalke 04
- **年齢**: 40  |  **代表キャップ**: 148  |  **代表得点**: 73
- **能力値**: PAC 55 / SHO 82 / PAS 74 / DRI 77 / DEF 40 / PHY 72

### Ermedin Demirović (OVR 80)
- **ポジション**: FW  |  **クラブ**: VfB Stuttgart
- **年齢**: 28  |  **代表キャップ**: 39  |  **代表得点**: 4
- **能力値**: PAC 72 / SHO 81 / PAS 73 / DRI 78 / DEF 42 / PHY 78

### Sead Kolašinac (OVR 79)
...
グループ **B** の対戦相手: Canada, Qatar, Switzerland
