# Argentina (ARG) — チーム分析レポート

> **グループ J** ｜ 主戦フォーメーション: `4-4-2` ｜ 平均OVR: **81.8** ｜ 分析試合数: 13試合 (StatsBomb)
...
### Lautaro Martínez (OVR 88)
- **ポジション**: FW  |  **クラブ**: Inter Milan
...
### Lionel Messi (OVR 86)
- **ポジション**: FW  |  **クラブ**: Inter Miami CF
- **年齢**: 38  |  **代表キャップ**: 198  |  **代表得点**: 116
- **能力値**: PAC 78 / SHO 85 / PAS 85 / DRI 90 / DEF 33 / PHY 64

### Emiliano Martínez (OVR 85)
- **ポジション**: GK  |  **クラブ**: Aston Villa
- **年齢**: 33  |  **代表キャップ**: 59  |  **代表得点**: 0
...
### 主フォーメーション: 4-4-2
> 縦2トップにコンパクトな2ラインを形成。ブロック守備とカウンターを軸とする。
...
|------|----------|:------:|:---------------:|
| FIFA World Cup 2022 | Croatia | 3-0 | 4-4-2 |
| FIFA World Cup 2022 | Saudi Arabia | 1-2 | 4-4-2 |
| Copa America 2024 | Chile | 1-0 | 4-4-2 |
| Copa America 2024 | Peru | 2-0 | 4-3-3 |
| Copa America 2024 | Colombia | 1-0 | 4-4-2 |
| Copa America 2024 | Canada | 2-0 | 4-4-2 |
| Copa America 2024 | Ecuador | 1-1 | 4-4-2 |
| Copa America 2024 | Canada | 2-0 | 4-4-2 |
...
- 2ラインのコンパクトなブロックで守備が安定し、ロングカウンターを得意とする
- 2トップが前線でタメを作ることで、中盤の飛び出しとの連携が生まれやすい
- GK陣のクオリティが高く（最高OVR 85）、セービングでチームを救える場面が多い
- FW陣に個人打開できる選手（最高OVR 88）がおり、1対1でも差を作れる

### ⚠️ 不利になりやすい状況

- ポゼッション型チームに中盤を制圧されると、自陣に押し込まれる展開になりやすい
- 4バックと4MFの間のライン間スペースを使われると、崩されやすい

---
## 5. グループステージ展望

グループ **J** の対戦相手: Algeria, Austria, Jordan
