...
> **グループ I** ｜ 主戦フォーメーション: `不明` ｜ 平均OVR: **66.2** ｜ 分析試合数: 0試合 (StatsBomb)
...
### Amir Al-Ammari (OVR 65)
- **ポジション**: MF  |  **クラブ**: Cracovia
- **年齢**: 28  |  **代表キャップ**: 49  |  **代表得点**: 3
- **能力値**: PAC 68 / SHO 57 / PAS 66 / DRI 63 / DEF 60 / PHY 70
...
グループ **I** の対戦相手: France, Senegal, Norway
