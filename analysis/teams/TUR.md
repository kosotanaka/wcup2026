# Türkiye (TUR) — チーム分析レポート

> **グループ D** ｜ 主戦フォーメーション: `4-2-3-1` ｜ 平均OVR: **77.7** ｜ 分析試合数: 5試合 (StatsBomb)
...
### Hakan Çalhanoğlu (OVR 86)
- **ポジション**: MF  |  **クラブ**: Inter Milan
...
### Abdülkerim Bardakcı (OVR 80)
- **ポジション**: DF  |  **クラブ**: Galatasaray
- **年齢**: 31  |  **代表キャップ**: 26  |  **代表得点**: 2
- **能力値**: PAC 59 / SHO 46 / PAS 70 / DRI 69 / DEF 81 / PHY 85
...
|------|----------|:------:|:---------------:|
| UEFA Euro 2024 | Georgia | 3-1 | 4-2-3-1 |
| UEFA Euro 2024 | Portugal | 0-3 | 4-2-3-1 |
| UEFA Euro 2024 | Netherlands | 1-2 | 3-4-3 |
| UEFA Euro 2024 | Czech Republic | 2-1 | 4-2-3-1 |
| UEFA Euro 2024 | Austria | 2-1 | 3-4-3 |
...
グループ **D** の対戦相手: USA, Paraguay, Australia
